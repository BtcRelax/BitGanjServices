...
class LHCApi
{
    ...
    {
        if (empty($this->User)) {
            $this->User = $this->getCurrentSession()->getValue('CurrentUser');
        }
        return $this->User;
    }
    ...
    {
        $vCurrentSession = $this->getCurrentSession();
        $script = "";
        ...
        if (empty($script)) {
            $script = $this->fillFAQWidget('main', LHC_URL);
        }
        return $script ;
    }
    ...
    {
        $vCurrentSession = $this->getCurrentSession();
        $vCurrentSession->setValue('isHasLHCAccount', true);
        $dataRequest = array();
