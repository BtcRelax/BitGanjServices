...
class PushbulletApi
{
    ...
    public function getIsInited():bool
    {
        return $this->isInited;
    }
  
    public function init(string $pToken)
    {
        $this->isInited = false;
        ...
        if ($response->getStatusCode() === 200) {
            ...
            $this->lastError = \sprintf("Server return code:%s", $response->getStatusCode());
        }
        return $this->isInited;
    }
    ...
    public function pushMessage(string $message)
    {
        ...
        if ($response->getStatusCode() === 200) {
            ...
            $this->lastError = \sprint("Server return code:%s", $response->getStatusCode());
        };
        return $result;
    }
}
